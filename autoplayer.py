#autoplayer. Automatically generates a random number to guess against and uses the "better" algorithm to automatically solve it.
...
real_real = random.randint(1000,10000)
#real_real = 1234
print(real_real)
