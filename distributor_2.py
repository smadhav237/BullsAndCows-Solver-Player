...
#The algorithm used here scored slighty worse on average across the entire spectrum, but is more consistent across different types of numbers from experience.
